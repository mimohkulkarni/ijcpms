...
if($_GET['d'] == null){
    ...
    $sqlArticles = "SELECT * FROM `articles` WHERE `issues_id` = '".$issueId."'";
//    echo $sqlArticles;
    $resultArticles = mysqli_query($linkId,$sqlArticles);
    ...
    if ($articleCount > 0){
        while($rowArticle = mysqli_fetch_array($resultArticles)){
            $articleDownloadScore = $articleDownloadScore + $rowArticle['dcount'];
        }
    }
//    else  header("location:page_404.php");

//if (mysqli_num_rows($resultArticles) > 0){
    $sqlIssue = "SELECT `name`, `vol`, `date` FROM `issues` WHERE `id` = '".$issueId."'";
                        ...
                        <div class="latest_news">
                            ...
                            if ($articleCount > 0) {
                                ...
                                <table class="table table-hover table-striped table-bordered">
                                    ...
                                    $i = 1;
                                    $resultArticles = mysqli_query($linkId, $sqlArticles);
                                    while ($rowArticles = mysqli_fetch_array($resultArticles)) {
                                        ?>
                                        <tr>
                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        <div class="choice_text">
                                                            <a href="#"><h4><?php echo $rowArticles['name']; ?></h4></a>
                                                            <p style="justify-content: flex-start;"><?php echo $rowArticles['authors']; ?></p>
                                                            <span class="p-1"
                                                                  style="background: #808080;border-radius: 5px;"><?php echo $rowArticles['type']; ?></span>
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    Submitted on &nbsp;<i class="fa fa-calendar"
                                                                                          aria-hidden="true"></i> <?php echo date("F j, Y", strtotime($rowArticles['subdate'])); ?>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    Published on &nbsp;<i class="fa fa-calendar"
                                                                                          aria-hidden="true"></i> <?php echo date("F j, Y", strtotime($rowArticles['pubdate'])); ?>
                                                                </div>
                                                            </div>
                                                            <div class="my-3 text-center">
                                                                <a class="gad_btn"
                                                                   href="article.php?d=<?php echo $rowArticles['id']; ?>">Abstract</a>
                                                                <span class="gad_btn ml-2 download"
                                                                      id="<?php echo $rowArticles['id']; ?>"
                                                                      style="cursor: pointer;">Download Full Article PDF</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center"><?php echo $rowArticles['dcount']; ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th scope="col" colspan="3">Oops! No articles found</th>
                                    </tr>
                                    </thead>
                                </table>
                            <?php
                        ...
                        <div class="right_sidebar">
                            <aside class="r_widgets social_widgets">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="fa fa-file-download"></i> Download Score <span><?php echo  $articleDownloadScore; ?></span></a></li>
                                </ul>
                            </aside>
                            <div>
                                <div class="main_title2">
