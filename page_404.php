...
<html lang="en">
    <head>
      ...
      <body>
        ...
        <h1>404</h1>
        <h2>Oops! Looks like the page you are looking for does not exists or removed from server!</h2>
        <h4>Redirecting to Homepage in 10 seconds...</h4><span class="spinner-border spinner-border-sm"></span>
        <h4><a href="index.php" class="genric-btn info circle">Go Back To Homepage <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></h4>
      </body>
</html>
